...
**动作动态类（新增）**
- **动态表现**：快速剪辑、慢动作、动态构图、倾斜角度、肾上腺素、生死对决、拳脚相交、溅起水花、搏斗、霓虹灯光

**情感表达类（新增）**
- **情感表现**：泪光、微笑、苦涩、温柔、恐惧、顿悟、老照片、柔光、私密、描摹、瞳孔收缩、深影

**环境氛围类（新增）**
- **氛围营造**：浮空城市、长吊桥、瀑布、霓虹灯光、混凝土、小窗、燃烧橙、体积光、云层缝隙、单一光源

**叙事节奏类（新增）**
- **节奏控制**：一触即发、描摹边缘、难以捉摸、攻击性、气势逼人、牢笼般、绿与灰
...
def check_element_preservation(original: str, simplified: str) -> Dict:
    ...
    p2_keywords = [
        ...
        "生死对决", "拳脚相交", "溅起水花", "搏斗", "霓虹灯光",
        
        # 情感表达类（新增）
        "泪光", "微笑", "苦涩", "温柔", "恐惧", "顿悟",
        "老照片", "柔光", "私密", "描摹", "瞳孔收缩", "深影",
        
        # 环境氛围类（新增）
        "浮空城市", "长吊桥", "瀑布", "霓虹灯光", "混凝土",
        "小窗", "燃烧橙", "体积光", "云层缝隙", "单一光源",
        
        # 叙事节奏类（新增）
        "一触即发", "描摹边缘", "难以捉摸", "攻击性", "气势逼人",
        "牢笼般", "绿与灰"
    ]  # P2关键词列表（58个关键词）
...
| v1.3 | 2026-01-30 | 更新P2关键词列表（58个关键词，9个类别） |
